// Code generators for domain "Typedfields".
...
javascript.javascriptGenerator.forBlock['WidgetStyle'] = function(block) {
  var visible = block.getFieldValue('visible');
  var width = block.getFieldValue('width');
  var accentColor = block.getFieldValue('accentColor');
  return '{' +   '"_type": "WidgetStyle", "_blockId": ' + JSON.stringify(block.id) +  ', "visible": ' + JSON.stringify(visible) +  ', "width": ' + JSON.stringify(width) +  ', "accentColor": ' + JSON.stringify(accentColor) + ' },\n';
};
...
'WidgetStyle': {
  label: 'WidgetStyle',
  template: null,
  fields: ['visible', 'width', 'accentColor'],
  fieldTypes: {'visible': 'BOOLEAN', 'width': 'INTEGER', 'accentColor': 'COLOUR'},
  references: [],
  values: [],
  statements: []
}
