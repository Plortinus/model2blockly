// Block definitions for domain "Annotatedcustomization".
...
{
	"type": "TaskBoard",
	"message0": "TaskBoard %1 %2",
	"args0": [{"type": "field_input", "name": "name", "text": "Sprint board"}, {"type": "input_statement", "name": "tasks", "check": "Task"}],
	"colour": 210,
	"tooltip": "A board that contains tasks.",
	"helpUrl": ""
},
{
	"type": "Task",
	"message0": "Task %1 %2 %3",
	"args0": [{"type": "field_input", "name": "title", "text": "Write docs"}, {"type": "field_checkbox", "name": "done", "checked": false}, {"type": "field_dropdown", "name": "priority", "options": [["low", "low"], ["medium", "medium"], ["high", "high"]]}],
