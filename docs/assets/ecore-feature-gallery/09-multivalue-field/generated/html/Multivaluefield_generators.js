// Code generators for domain "Multivaluefield".
...
javascript.javascriptGenerator.forBlock['TagSet'] = function(block) {
  var name = block.getFieldValue('name');
  var tags = parseBlocklyListField(block.getFieldValue('tags'));
  return '{' +   '"_type": "TagSet", "_blockId": ' + JSON.stringify(block.id) +  ', "name": ' + JSON.stringify(name) +  ', "tags": ' + JSON.stringify(tags) + ' },\n';
};
...
'TagSet': {
  ...
  template: null,
  fields: ['name', 'tags'],
  fieldTypes: {'name': 'TEXT', 'tags': 'TEXT'},
  references: [],
  values: [],
  statements: []
}
