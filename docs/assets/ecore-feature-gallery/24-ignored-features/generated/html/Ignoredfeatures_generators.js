// Code generators for domain "Ignoredfeatures".
...
javascript.javascriptGenerator.forBlock['DebugRecord'] = function(block) {
  var visibleName = block.getFieldValue('visibleName');
  return '{' +   '"_type": "DebugRecord", "_blockId": ' + JSON.stringify(block.id) +  ', "visibleName": ' + JSON.stringify(visibleName) + ' },\n';
};
