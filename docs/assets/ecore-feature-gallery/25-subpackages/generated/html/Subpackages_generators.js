// Code generators for domain "Subpackages".
...
javascript.javascriptGenerator.forBlock['Dashboard'] = function(block) {
  var title = block.getFieldValue('title');
  return '{' +   '"_type": "Dashboard", "_blockId": ' + JSON.stringify(block.id) +  ', "title": ' + JSON.stringify(title) + ' },\n';
};
javascript.javascriptGenerator.forBlock['Chart'] = function(block) {
  var series = block.getFieldValue('series');
  return '{' +   '"_type": "Chart", "_blockId": ' + JSON.stringify(block.id) +  ', "series": ' + JSON.stringify(series) + ' },\n';
};
