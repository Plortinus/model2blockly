// Code generators for domain "Referenceselect".
...
javascript.javascriptGenerator.forBlock['Flow'] = function(block) {
  ...
  return '{' +   '"_type": "Flow", "_blockId": ' + JSON.stringify(block.id) +   ', "pages": ' + (pages_stmt ? '[' + pages_stmt + ']' : '[]') +   ', "actions": ' + (actions_stmt ? '[' + actions_stmt + ']' : '[]') + ' },\n';
};
javascript.javascriptGenerator.forBlock['Page'] = function(block) {
  var name = block.getFieldValue('name');
  return '{' +   '"_type": "Page", "_blockId": ' + JSON.stringify(block.id) +  ', "_modelId": ' + JSON.stringify(name || block.id) +  ', "name": ' + JSON.stringify(name) + ' },\n';
};
