// Toolbox for domain "Outputblocks".
	...
	"contents": [
		{
			...
			"colour": "260",
			"contents": [
				{"kind": "block", "type": "Threshold", "inputs": {"value": {
					"shadow": { "type": "NumberLiteral" }
				}
								}}
			]
		},
			...
			"colour": "230",
			"contents": [
				{"kind": "block", "type": "NumberLiteral"},
								{"kind": "block", "type": "Add", "inputs": {"left": {
					"shadow": { "type": "NumberLiteral" }
				},"right": {
					"shadow": { "type": "NumberLiteral" }
				}
