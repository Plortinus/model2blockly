// Code generators for domain "Outputblocks".
...
javascript.javascriptGenerator.forBlock['Threshold'] = function(block) {
  var value_code = javascript.javascriptGenerator.valueToCode(block, 'value', 0) || 'null';
  return '{' +   '"_type": "Threshold", "_blockId": ' + JSON.stringify(block.id) +  ', "value": ' + value_code + ' },\n';
};
javascript.javascriptGenerator.forBlock['NumberLiteral'] = function(block) {
  var value = block.getFieldValue('value');
  var code = '{' +   '"_type": "NumberLiteral", "_blockId": ' + JSON.stringify(block.id) +  ', "value": ' + JSON.stringify(value) + ' }';
  return [code, 0];
};
javascript.javascriptGenerator.forBlock['Add'] = function(block) {
  ...
  var code = '{' +   '"_type": "Add", "_blockId": ' + JSON.stringify(block.id) +  ', "left": ' + left_code +  ', "right": ' + right_code + ' }';
  return [code, 0];
};
