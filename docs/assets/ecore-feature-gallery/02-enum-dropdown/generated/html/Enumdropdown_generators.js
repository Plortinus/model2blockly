// Code generators for domain "Enumdropdown".
...
javascript.javascriptGenerator.forBlock['Task'] = function(block) {
  ...
  return '{' +   '"_type": "Task", "_blockId": ' + JSON.stringify(block.id) +  ', "priority": ' + JSON.stringify(priority) + ' },\n';
};
