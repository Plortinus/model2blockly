// Code generators for domain "Flyouttoolbox".
...
javascript.javascriptGenerator.forBlock['QuickNote'] = function(block) {
  var text = block.getFieldValue('text');
  return '{' +   '"_type": "QuickNote", "_blockId": ' + JSON.stringify(block.id) +  ', "text": ' + JSON.stringify(text) + ' },\n';
};
javascript.javascriptGenerator.forBlock['QuickFlag'] = function(block) {
  var enabled = block.getFieldValue('enabled');
  return '{' +   '"_type": "QuickFlag", "_blockId": ' + JSON.stringify(block.id) +  ', "enabled": ' + JSON.stringify(enabled) + ' },\n';
};
