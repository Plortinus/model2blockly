// Block definitions for domain "Abstracttype".
...
window.BLOCKLY_BLOCKS = [
{
	"type": "Screen",
	"message0": "Screen %1",
	"args0": [{"type": "input_statement", "name": "components", "check": "Component"}],
	"colour": 260,
	"tooltip": "Screen",
	"helpUrl": ""
},
{
	"type": "Text",
	"message0": "Text %1",
	"args0": [{"type": "field_input", "name": "value", "text": "Name"}],
...
},
{
	"type": "Image",
	"message0": "Image %1",
	"args0": [{"type": "field_input", "name": "url", "text": "https://example.com/avatar.png"}],
	"previousStatement": "Component", "nextStatement": "Component",
	"colour": 160,
	"tooltip": "Image",
	"helpUrl": ""
