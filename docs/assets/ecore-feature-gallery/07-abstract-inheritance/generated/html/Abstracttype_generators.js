// Code generators for domain "Abstracttype".
...
javascript.javascriptGenerator.forBlock['Screen'] = function(block) {
  ...
  return '{' +   '"_type": "Screen", "_blockId": ' + JSON.stringify(block.id) +   ', "components": ' + (components_stmt ? '[' + components_stmt + ']' : '[]') + ' },\n';
};
javascript.javascriptGenerator.forBlock['Text'] = function(block) {
  var value = block.getFieldValue('value');
  return '{' +   '"_type": "Text", "_blockId": ' + JSON.stringify(block.id) +  ', "value": ' + JSON.stringify(value) + ' },\n';
};
javascript.javascriptGenerator.forBlock['Image'] = function(block) {
  var url = block.getFieldValue('url');
  return '{' +   '"_type": "Image", "_blockId": ' + JSON.stringify(block.id) +  ', "url": ' + JSON.stringify(url) + ' },\n';
};
