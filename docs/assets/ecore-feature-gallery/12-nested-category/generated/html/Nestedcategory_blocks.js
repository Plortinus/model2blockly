// Block definitions for domain "Nestedcategory".
...
window.BLOCKLY_BLOCKS = [
{
	"type": "Screen",
	"message0": "Screen %1",
	"args0": [{"type": "input_statement", "name": "controls", "check": "Component"}],
	"colour": 260,
	"tooltip": "Screen",
	"helpUrl": ""
},
{
	"type": "TextInput",
	"message0": "TextInput %1",
	"args0": [{"type": "field_input", "name": "label", "text": "Name"}],
...
{
	"type": "SubmitButton",
	"message0": "SubmitButton %1",
	"args0": [{"type": "field_input", "name": "label", "text": "Submit"}],
	"previousStatement": "Component", "nextStatement": "Component",
	"inputsInline": true,
	"colour": 160,
