// Block definitions for domain "Validationrule".
...
window.BLOCKLY_BLOCKS = [
{
	"type": "Flow",
	"message0": "Flow %1",
	"args0": [{"type": "input_statement", "name": "actions", "check": "Action"}],
	"colour": 260,
	"tooltip": "Flow",
	"helpUrl": ""
},
{
	"type": "Alert",
	"message0": "Alert %1",
	"args0": [{"type": "field_input", "name": "message", "text": "Leaving page"}],
...
},
{
	"type": "Navigate",
	"message0": "Navigate %1",
	"args0": [{"type": "field_input", "name": "target", "text": "details"}],
	"previousStatement": "Action", "nextStatement": "Action",
	"colour": 30,
	"tooltip": "Navigate",
	"helpUrl": ""
