...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Statement Input Spec</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getCheckType <em>Check Type</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiWidget <em>Ui Widget</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiLabel <em>Ui Label</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiHelp <em>Ui Help</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiPlaceholder <em>Ui Placeholder</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiGroup <em>Ui Group</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiOrder <em>Ui Order</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#isUiReadonly <em>Ui Readonly</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#isUiHidden <em>Ui Hidden</em>}</li>
 *   <li>{@link io.github.plortinus.model2blockly.intermediate.blocklyspec.impl.StatementInputSpecImpl#getUiVariant <em>Ui Variant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatementInputSpecImpl extends MinimalEObjectImpl.Container implements StatementInputSpec {
	/**
	 ...
	 * @generated
	 */
	protected StatementInputSpecImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BlocklySpecPackage.Literals.STATEMENT_INPUT_SPEC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__NAME, oldName, name));
	}
	...
	public void setCheckType(String newCheckType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__CHECK_TYPE, oldCheckType, checkType));
	}
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public void setUiWidget(String newUiWidget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_WIDGET, oldUiWidget, uiWidget));
	}
	...
	public void setUiLabel(String newUiLabel) {
		...
		uiLabel = newUiLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_LABEL, oldUiLabel, uiLabel));
	}
	...
	public void setUiHelp(String newUiHelp) {
		...
		uiHelp = newUiHelp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_HELP, oldUiHelp, uiHelp));
	}
	...
	public void setUiPlaceholder(String newUiPlaceholder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_PLACEHOLDER, oldUiPlaceholder, uiPlaceholder));
	}
	...
	public void setUiGroup(String newUiGroup) {
		...
		uiGroup = newUiGroup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_GROUP, oldUiGroup, uiGroup));
	}
	...
	public void setUiOrder(Integer newUiOrder) {
		...
		uiOrder = newUiOrder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_ORDER, oldUiOrder, uiOrder));
	}
	...
	public void setUiReadonly(boolean newUiReadonly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_READONLY, oldUiReadonly, uiReadonly));
	}
	...
	public void setUiHidden(boolean newUiHidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_HIDDEN, oldUiHidden, uiHidden));
	}
	...
	public void setUiVariant(String newUiVariant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_VARIANT, oldUiVariant, uiVariant));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__NAME:
				return getName();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__CHECK_TYPE:
				return getCheckType();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__LOWER_BOUND:
				return getLowerBound();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UPPER_BOUND:
				return getUpperBound();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_WIDGET:
				return getUiWidget();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_LABEL:
				return getUiLabel();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_HELP:
				return getUiHelp();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_PLACEHOLDER:
				return getUiPlaceholder();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_GROUP:
				return getUiGroup();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_ORDER:
				return getUiOrder();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_READONLY:
				return isUiReadonly();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_HIDDEN:
				return isUiHidden();
			case BlocklySpecPackage.STATEMENT_INPUT_SPEC__UI_VARIANT:
				return getUiVariant();
		}
