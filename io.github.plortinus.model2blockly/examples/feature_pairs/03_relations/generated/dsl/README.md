...
Input DSL model: `/Users/wxy/model2blockly/io.github.plortinus.model2blockly/examples/feature_pairs/03_relations/source.m2b`
...
2. Inspect `intermediate/Relations_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/Relations_standalone.html` in a browser to use the generated editor.
