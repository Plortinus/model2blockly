// Block definitions for domain "Relations".
...
window.BLOCKLY_BLOCKS = [
{
	...
	"args0": [{"type": "field_input", "name": "name", "text": "Review workflow"}, {"type": "input_statement", "name": "elements", "check": "Element"}],
	"inputsInline": false,
	"colour": 260,
	"tooltip": "Workflow",
	"helpUrl": ""
...
{
	"type": "Card",
	"message0": "Card %1 %2 %3 %4",
	"args0": [{"type": "field_input", "name": "cardId", "text": "card-1"}, {"type": "input_value", "name": "content", "check": "TextExpression"}, {"type": "field_input", "name": "title", "text": "Review"}, {"type": "field_reference_multiselect", "name": "outgoing", "text": "", "targetType": "Link", "labelField": "linkId"}],
...
{
	"type": "Link",
	"message0": "Link %1 %2 %3 %4",
	"args0": [{"type": "field_input", "name": "linkId", "text": "link-1"}, {"type": "field_dropdown", "name": "source", "options": [["(none)", ""]]}, {"type": "field_input", "name": "description", "text": "Continue"}, {"type": "field_dropdown", "name": "target", "options": [["(none)", ""]]}],
	"previousStatement": "Element", "nextStatement": "Element",
	"inputsInline": false,
	"colour": 120,
	"tooltip": "Link",
...
{
	"type": "TextLiteral",
	"message0": "TextLiteral %1",
	"args0": [{"type": "field_input", "name": "textValue", "text": "Ready"}],
