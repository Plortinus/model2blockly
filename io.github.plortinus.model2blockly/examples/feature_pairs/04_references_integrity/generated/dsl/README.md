...
Input DSL model: `/Users/wxy/model2blockly/io.github.plortinus.model2blockly/examples/feature_pairs/04_references_integrity/source.m2b`
...
2. Inspect `intermediate/ReferencesIntegrity_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/ReferencesIntegrity_standalone.html` in a browser to use the generated editor.
...
- Edit the `.m2b` source if the domain structure should change.
