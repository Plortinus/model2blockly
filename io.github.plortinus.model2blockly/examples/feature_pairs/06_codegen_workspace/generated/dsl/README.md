...
Input DSL model: `/Users/wxy/model2blockly/io.github.plortinus.model2blockly/examples/feature_pairs/06_codegen_workspace/source.m2b`
...
2. Inspect `intermediate/CodegenWorkspace_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/CodegenWorkspace_standalone.html` in a browser to use the generated editor.
