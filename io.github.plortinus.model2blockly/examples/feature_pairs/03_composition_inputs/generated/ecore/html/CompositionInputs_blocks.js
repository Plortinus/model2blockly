// Block definitions for domain "CompositionInputs".
...
window.BLOCKLY_BLOCKS = [
{
	...
	"message0": "Document",
		"args0": [],
	"message1": "Title %1",
		"args1": [{"type": "field_input", "name": "title", "text": "Release notes"}],
	"message2": "Sections %1",
		"args2": [{"type": "input_statement", "name": "sections", "check": "Section"}],
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Document",
	"helpUrl": ""
},
{
	...
	"message0": "Paragraph",
		"args0": [],
	"message1": "Heading %1",
		"args1": [{"type": "field_input", "name": "heading", "text": "Summary"}],
	"message2": "Content %1",
		"args2": [{"type": "input_value", "name": "content", "check": "TextExpression"}],
	"message3": "Emphasis %1",
		"args3": [{"type": "field_checkbox", "name": "emphasis", "checked": false}],
	"previousStatement": "Section", "nextStatement": "Section",
	"inputsInline": false,
	"colour": 120,
	"tooltip": "Paragraph",
	"helpUrl": ""
...
{
	"type": "TextLiteral",
	"message0": "TextLiteral",
		"args0": [],
	"message1": "Text %1",
		"args1": [{"type": "field_input", "name": "textValue", "text": "Ready"}],
