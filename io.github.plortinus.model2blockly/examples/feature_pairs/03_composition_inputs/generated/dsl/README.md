...
Input DSL model: `/Users/wxy/model2blockly/io.github.plortinus.model2blockly/examples/feature_pairs/03_composition_inputs/source.m2b`
...
2. Inspect `intermediate/CompositionInputs_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/CompositionInputs_standalone.html` in a browser to use the generated editor.
