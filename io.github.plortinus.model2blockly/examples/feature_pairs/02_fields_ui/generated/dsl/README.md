...
Input DSL model: `io.github.plortinus.model2blockly/examples/feature_pairs/02_fields_ui/source.m2b`
...
2. Inspect `intermediate/FieldsUi_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/FieldsUi_standalone.html` in a browser to use the generated editor.
