// Block definitions for domain "BasicStructure".
...
window.BLOCKLY_BLOCKS = [
{
	...
	"message0": "Board",
					"args0": [],
	"message1": "name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "Sprint board"}],
	"message2": "items %1",
						"args2": [{"type": "input_statement", "name": "items", "check": "WorkItem"}],
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Board",
	"helpUrl": ""
},
{
	...
	"message0": "Task",
					"args0": [],
	"message1": "title %1",
						"args1": [{"type": "field_input", "name": "title", "text": "Write docs"}],
	"message2": "priority %1",
						"args2": [{"type": "field_dropdown", "name": "priority", "options": [["low", "low"], ["medium", "medium"], ["high", "high"]]}],
	"message3": "done %1",
						"args3": [{"type": "field_checkbox", "name": "done", "checked": false}],
	"previousStatement": "WorkItem", "nextStatement": "WorkItem",
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Task",
	"helpUrl": ""
},
{
	...
	"message0": "Note",
					"args0": [],
	"message1": "body %1",
						"args1": [{"type": "field_input", "name": "body", "text": "Remember the review"}],
	"previousStatement": "WorkItem", "nextStatement": "WorkItem",
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Note",
...
},
{
	...
	"message0": "Tag",
					"args0": [],
	"message1": "name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "important"}],
