const blockTypes = ['graph_get_x', 'graph_set_y'];
...
const adapter = {
  ...
  async register({ Blockly, javascriptGenerator }) {
    ...
    const [blocksSource, toolboxSource, generatorsSource] = await Promise.all([
      load('../generated-ecore/html/Graph_blocks.js'),
      load('../generated-ecore/html/Graph_toolbox.js'),
      load('../generated-ecore/html/Graph_generators.js'),
    ]);
