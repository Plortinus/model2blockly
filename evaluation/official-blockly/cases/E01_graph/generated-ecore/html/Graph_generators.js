// Code generators for domain "Graph".
...
javascript.javascriptGenerator.forBlock['graph_get_x'] = function(block) {
  var code = '{' +   '"_type": "graph_get_x", "_blockId": ' + JSON.stringify(block.id) + ' }';
  return [code, 0];
};
javascript.javascriptGenerator.forBlock['graph_set_y'] = function(block) {
  ...
  return '{' +   '"_type": "graph_set_y", "_blockId": ' + JSON.stringify(block.id) +  ', "VALUE": ' + VALUE_code + ' },\n';
};
