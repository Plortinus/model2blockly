...
Input DSL model: `/Users/wxy/model2blockly/evaluation/official-blockly/cases/E04_bird/source.m2b`
...
2. Inspect `intermediate/Bird_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/Bird_standalone.html` in a browser to use the generated editor.
