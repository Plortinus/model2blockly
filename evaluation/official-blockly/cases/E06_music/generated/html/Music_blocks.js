// Block definitions for domain "Music".
...
window.BLOCKLY_BLOCKS = [
{
	"type": "music_pitch",
	"message0": "%1",
	"args0": [{"type": "field_number", "name": "PITCH", "value": 7, "precision": 1, "min": 0, "max": 12}],
	"output": "Number",
	"inputsInline": false,
	"colour": 230,
...
},
{
	...
	"args0": [{"type": "field_dropdown", "name": "DURATION", "options": [["1/1", "whole"], ["1/2", "half"], ["1/4", "quarter"], ["1/8", "eighth"], ["1/16", "sixteenth"]]}, {"type": "input_value", "name": "PITCH", "check": "Number"}],
	"previousStatement": "MusicCommand", "nextStatement": "MusicCommand",
	"inputsInline": true,
	"colour": 160,
...
},
{
	...
	"message0": "rest %1",
	"args0": [{"type": "field_image", "src": "music/rest1.png", "width": 10, "height": 20, "alt": "1/1"}],
	"previousStatement": "MusicCommand", "nextStatement": "MusicCommand",
	"inputsInline": true,
	"colour": 160,
...
},
{
	"type": "music_rest",
	"message0": "rest %1",
	"args0": [{"type": "field_dropdown", "name": "DURATION", "options": [["1/1", "whole"], ["1/2", "half"], ["1/4", "quarter"], ["1/8", "eighth"], ["1/16", "sixteenth"]]}],
	"previousStatement": "MusicCommand", "nextStatement": "MusicCommand",
	"inputsInline": true,
	"colour": 160,
...
},
{
	...
	"args0": [{"type": "field_dropdown", "name": "INSTRUMENT", "options": [["piano", "piano"], ["trumpet", "trumpet"], ["banjo", "banjo"], ["violin", "violin"], ["guitar", "guitar"], ["flute", "flute"], ["drum", "drum"], ["choir", "choir"]]}],
	"previousStatement": "MusicCommand", "nextStatement": "MusicCommand",
	"inputsInline": true,
	"colour": 160,
...
},
{
	...
	"args0": [{"type": "field_image", "src": "music/play.png", "width": 17, "height": 17, "alt": "▶"}, {"type": "input_statement", "name": "STACK", "check": "MusicCommand"}],
	"inputsInline": false,
	"colour": 0,
