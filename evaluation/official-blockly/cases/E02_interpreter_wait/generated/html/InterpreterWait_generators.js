// Code generators for domain "InterpreterWait".
...
javascript.javascriptGenerator.forBlock['wait_seconds'] = function(block) {
  ...
  return '{' +   '"_type": "wait_seconds", "_blockId": ' + JSON.stringify(block.id) +  ', "SECONDS": ' + JSON.stringify(SECONDS) + ' },\n';
};
