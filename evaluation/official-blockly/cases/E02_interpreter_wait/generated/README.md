...
Input DSL model: `/Users/wxy/model2blockly/evaluation/official-blockly/cases/E02_interpreter_wait/source.m2b`
...
2. Inspect `intermediate/InterpreterWait_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/InterpreterWait_standalone.html` in a browser to use the generated editor.
