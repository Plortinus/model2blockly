// Code generators for domain "Movie".
...
javascript.javascriptGenerator.forBlock['movie_circle'] = function(block) {
  var X_code = javascript.javascriptGenerator.valueToCode(block, 'X', 0) || 'null';
  var Y_code = javascript.javascriptGenerator.valueToCode(block, 'Y', 0) || 'null';
  var RADIUS_code = javascript.javascriptGenerator.valueToCode(block, 'RADIUS', 0) || 'null';
  return '{' +   '"_type": "movie_circle", "_blockId": ' + JSON.stringify(block.id) +  ', "X": ' + X_code +  ', "Y": ' + Y_code +  ', "RADIUS": ' + RADIUS_code + ' },\n';
};
javascript.javascriptGenerator.forBlock['movie_rect'] = function(block) {
  var X_code = javascript.javascriptGenerator.valueToCode(block, 'X', 0) || 'null';
  var Y_code = javascript.javascriptGenerator.valueToCode(block, 'Y', 0) || 'null';
  var WIDTH_code = javascript.javascriptGenerator.valueToCode(block, 'WIDTH', 0) || 'null';
  var HEIGHT_code = javascript.javascriptGenerator.valueToCode(block, 'HEIGHT', 0) || 'null';
  return '{' +   '"_type": "movie_rect", "_blockId": ' + JSON.stringify(block.id) +  ', "X": ' + X_code +  ', "Y": ' + Y_code +  ', "WIDTH": ' + WIDTH_code +  ', "HEIGHT": ' + HEIGHT_code + ' },\n';
};
javascript.javascriptGenerator.forBlock['movie_line'] = function(block) {
  var X1_code = javascript.javascriptGenerator.valueToCode(block, 'X1', 0) || 'null';
  var Y1_code = javascript.javascriptGenerator.valueToCode(block, 'Y1', 0) || 'null';
  var X2_code = javascript.javascriptGenerator.valueToCode(block, 'X2', 0) || 'null';
  var Y2_code = javascript.javascriptGenerator.valueToCode(block, 'Y2', 0) || 'null';
  var WIDTH_code = javascript.javascriptGenerator.valueToCode(block, 'WIDTH', 0) || 'null';
  return '{' +   '"_type": "movie_line", "_blockId": ' + JSON.stringify(block.id) +  ', "X1": ' + X1_code +  ', "Y1": ' + Y1_code +  ', "X2": ' + X2_code +  ', "Y2": ' + Y2_code +  ', "WIDTH": ' + WIDTH_code + ' },\n';
};
javascript.javascriptGenerator.forBlock['movie_time'] = function(block) {
  var code = '{' +   '"_type": "movie_time", "_blockId": ' + JSON.stringify(block.id) + ' }';
  return [code, 0];
};
javascript.javascriptGenerator.forBlock['movie_colour'] = function(block) {
  var COLOUR_code = javascript.javascriptGenerator.valueToCode(block, 'COLOUR', 0) || 'null';
  return '{' +   '"_type": "movie_colour", "_blockId": ' + JSON.stringify(block.id) +  ', "COLOUR": ' + COLOUR_code + ' },\n';
};
