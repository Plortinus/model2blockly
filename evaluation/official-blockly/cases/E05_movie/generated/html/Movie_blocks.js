// Block definitions for domain "Movie".
...
{
	"type": "movie_circle",
	"message0": "circle x%1y%2radius%3",
	"args0": [{"type": "input_value", "name": "X", "check": "Number"}, {"type": "input_value", "name": "Y", "check": "Number"}, {"type": "input_value", "name": "RADIUS", "check": "Number"}],
	"previousStatement": null, "nextStatement": null,
	"inputsInline": false,
	"colour": 160,
	"tooltip": "Draws a circle at the specified location and with the specified radius.",
	"helpUrl": ""
},
{
	"type": "movie_rect",
	"message0": "rectangle x%1y%2width%3height%4",
	"args0": [{"type": "input_value", "name": "X", "check": "Number"}, {"type": "input_value", "name": "Y", "check": "Number"}, {"type": "input_value", "name": "WIDTH", "check": "Number"}, {"type": "input_value", "name": "HEIGHT", "check": "Number"}],
	"previousStatement": null, "nextStatement": null,
	"inputsInline": false,
	"colour": 160,
	"tooltip": "Draws a rectangle at the specified location and with the specified width and height.",
	"helpUrl": ""
},
{
	"type": "movie_line",
	"message0": "line start x%1start y%2end x%3end y%4width%5",
	"args0": [{"type": "input_value", "name": "X1", "check": "Number"}, {"type": "input_value", "name": "Y1", "check": "Number"}, {"type": "input_value", "name": "X2", "check": "Number"}, {"type": "input_value", "name": "Y2", "check": "Number"}, {"type": "input_value", "name": "WIDTH", "check": "Number"}],
	"previousStatement": null, "nextStatement": null,
	"inputsInline": false,
	"colour": 160,
	"tooltip": "Draws a line from one point to another with the specified width.",
	"helpUrl": ""
},
{
	"type": "movie_time",
	...
	"inputsInline": false,
	"colour": 330,
	"tooltip": "Returns the current time in the animation (0-100).",
	"helpUrl": ""
},
{
	"type": "movie_colour",
