...
Input DSL model: `/Users/wxy/model2blockly/evaluation/official-blockly/cases/E05_movie/source.m2b`
...
2. Inspect `intermediate/Movie_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/Movie_standalone.html` in a browser to use the generated editor.
