// Block definitions for domain "Maze".
...
},
{
	"type": "maze_turn",
	"message0": "%1",
	"args0": [{"type": "field_dropdown", "name": "DIR", "options": [["turn left ↺", "turnLeft"], ["turn right ↻", "turnRight"]]}],
	"previousStatement": "Command", "nextStatement": "Command",
	"inputsInline": false,
	"colour": 290,
...
},
{
	...
	"args0": [{"type": "field_image", "src": "maze/marker.png", "width": 12, "height": 16, "alt": ""}, {"type": "input_statement", "name": "DO", "check": "Command"}],
	"previousStatement": "Command", "nextStatement": "Command",
	"inputsInline": false,
	"colour": 120,
...
},
{
	"type": "maze_if",
	"message0": "%1 do %2",
	"args0": [{"type": "field_dropdown", "name": "DIR", "options": [["if path ahead", "isPathForward"], ["if path to the left ↺", "isPathLeft"], ["if path to the right ↻", "isPathRight"]]}, {"type": "input_statement", "name": "DO", "check": "Command"}],
	"previousStatement": "Command", "nextStatement": "Command",
	"inputsInline": false,
	"colour": 210,
...
},
{
	...
	"args0": [{"type": "field_dropdown", "name": "DIR", "options": [["if path ahead", "isPathForward"], ["if path to the left ↺", "isPathLeft"], ["if path to the right ↻", "isPathRight"]]}, {"type": "input_statement", "name": "DO", "check": "Command"}, {"type": "input_statement", "name": "ELSE", "check": "Command"}],
	"previousStatement": "Command", "nextStatement": "Command",
	"inputsInline": false,
	"colour": 210,
