...
Input DSL model: `/Users/wxy/model2blockly/evaluation/official-blockly/cases/E03_maze/source.m2b`
...
2. Inspect `intermediate/Maze_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/Maze_standalone.html` in a browser to use the generated editor.
