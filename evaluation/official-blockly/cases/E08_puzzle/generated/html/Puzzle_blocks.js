// Block definitions for domain "Puzzle".
...
{
	"type": "animal",
	"message0": "%1picture:%2legs:%3traits:%4",
	"args0": [{"type": "field_label", "name": "NAME", "text": "Duck"}, {"type": "input_value", "name": "PIC", "check": "picture"}, {"type": "field_dropdown", "name": "LEGS", "options": [["choose...", "choose"], ["  0  ", "snail"], ["  2  ", "duck"], ["  4  ", "cat"], ["  6  ", "bee"]]}, {"type": "input_statement", "name": "TRAITS", "check": "trait"}],
	"inputsInline": false,
	"colour": 120,
	"tooltip": "",
...
},
{
	"type": "picture",
	"message0": "%1",
	"args0": [{"type": "field_image", "src": "puzzle/duck.jpg", "width": 100, "height": 70, "alt": ""}],
	"output": null,
	"inputsInline": false,
	"colour": 30,
	"tooltip": "",
...
},
{
	"type": "trait",
	"message0": "%1",
	"args0": [{"type": "field_label", "name": "NAME", "text": "Feathers"}],
	"previousStatement": "trait", "nextStatement": "trait",
	"inputsInline": false,
	"colour": 290,
	"tooltip": "",
	"helpUrl": ""
