...
Input DSL model: `/Users/wxy/model2blockly/evaluation/official-blockly/cases/E09_pond_tutor/source.m2b`
...
2. Inspect `intermediate/PondTutor_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/PondTutor_standalone.html` in a browser to use the generated editor.
