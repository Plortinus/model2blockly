...
paleta y su configuración. El segundo define los bloques, sus campos y sus
...
paleta o el tipo de control utilizado para editar un valor. Por este motivo, la
...
convierte en definiciones de bloques, paleta, configuración del espacio de trabajo,
...
intermedio determina la paleta, la definición de cada tipo determina la forma
...
otro elemento existente en el espacio de trabajo, por lo que se representa mediante un
...
\begin{table}[h]
  \centering
  \begin{tabular}{|L{0.23\textwidth}|L{0.65\textwidth}|}
    \hline
    Objetivo específico & Respuesta arquitectónica \\
    \hline
    \textbf{OE1: estructura del editor} & El modelo intermedio identifica explícitamente los elementos que
    necesita un editor de bloques: tipos, campos, conexiones, categorías,
    referencias y validaciones. \\
    \textbf{OE2: ruta Ecore} & La ruta Ecore permite partir de metamodelos y
    derivar bloques, campos, entradas y reglas. \\
    \textbf{OE3: ruta \texttt{.m2b}} & La gramática Xtext proporciona la ruta textual \texttt{.m2b}
    para definir lenguajes de bloques de forma compacta. \\
    \textbf{OE4: modelo común} & El modelo intermedio común desacopla las entradas de los generadores
    y permite compartir la misma lógica de salida. \\
    \textbf{OE5: editor ejecutable} & Los generadores producen editores HTML/JavaScript ejecutables en el
    navegador. \\
    \textbf{OE6: mecanismos genéricos} & Las validaciones, referencias dinámicas, anotaciones de interfaz y
    plantillas de código se incorporan como capacidades genéricas. \\
    \textbf{OE7: evaluación} & La separación por transformación de entrada, modelo intermedio y
    generadores permite comparar la salida con editores existentes, localizar
    diferencias por propiedad y comprobar la coherencia entre rutas. \\
    \hline
  \end{tabular}
