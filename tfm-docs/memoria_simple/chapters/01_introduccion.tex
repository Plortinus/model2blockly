...
espacio de trabajo. El desarrollador, en cambio, debe definir los bloques, los campos, las
...
entradas, categorías de la paleta, reglas de conexión, serialización,
...
de complementos Eclipse y como una cadena de generación HTML/JavaScript. Admite dos
...
\texttt{EditorSpec}. Este modelo contiene los
...
creado por el usuario como JSON o XMI de instancia. Seis pares mínimos y
complementarios, formados por un metamodelo Ecore anotado y un fichero textual
\texttt{.m2b}, permiten explicar y verificar de forma trazable las capacidades
comunes de la cadena completa. Un caso Ecore independiente completa la cobertura
de las construcciones sin equivalente textual. La evaluación principal se
realiza por separado con diez configuraciones de editores
publicadas en los repositorios oficiales de Blockly. Esta separación permite
distinguir los ejemplos de implementación de la evidencia sobre la
capacidad para reproducir editores que no fueron diseñados para ella.
...
Blockly con bloques, paleta, páginas HTML, serialización, validaciones,
...
último, se aporta una evaluación reproducible con diez editores oficiales,
comparación de la fuente mantenida, verificación de las rutas Ecore y
\texttt{.m2b}, pruebas automáticas y artefactos desplegados públicamente.
...
mientras que el capítulo 5 detalla la ejecución y la implementación de
Model2Blockly mediante ejemplos reproducibles. El capítulo 6 evalúa la
herramienta frente a diez configuraciones de editores Blockly existentes. Por
