...
Input DSL model: `/Users/wxy/model2blockly/examples/feature_pairs/03_expressions_codegen/scriptedApp.m2b`
...
2. Inspect `intermediate/ScriptedApp_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/ScriptedApp_standalone.html` in a browser to use the generated editor.
