// Toolbox for domain "ScriptedApp".
	...
	"contents": [
		{
			...
			"contents": [
				{"kind": "block", "type": "Label"},
								{"kind": "block", "type": "Button", "inputs": {"enabledWhen": {
			...
			"colour": "230",
			"contents": [
				{"kind": "block", "type": "BoolLiteral"},
								{"kind": "block", "type": "PlatformIs"},
								{"kind": "block", "type": "NotExpression", "inputs": {"operand": {
					"shadow": { "type": "BoolLiteral" }
				}
								}}
			]
