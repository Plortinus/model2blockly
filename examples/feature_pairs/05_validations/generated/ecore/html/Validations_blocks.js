// Block definitions for domain "Validations".
...
window.BLOCKLY_BLOCKS = [
{
	...
	"message0": "Page id %1 title %2 route %3 actions %4",
					"args0": [{"type": "field_input", "name": "pageId", "text": "page-1"}, {"type": "field_input", "name": "title", "text": "Home"}, {"type": "field_input", "name": "route", "text": "/home"}, {"type": "input_statement", "name": "actions", "check": "Action"}],
	"inputsInline": false,
	"colour": 260,
	"tooltip": "Page",
	"helpUrl": ""
},
{
	...
	"message0": "Alert message %1",
					"args0": [{"type": "field_input", "name": "message", "text": "Saved"}],
