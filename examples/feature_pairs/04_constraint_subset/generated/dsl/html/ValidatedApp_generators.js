// Code generators for domain "ValidatedApp".
...
javascript.javascriptGenerator.forBlock['Button'] = function(block) {
  ...
  var backgroundColor = block.getFieldValue('backgroundColor');
  return '{' +   '"_type": "Button", "_blockId": ' + JSON.stringify(block.id) +  ', "text": ' + JSON.stringify(text) +  ', "width": ' + JSON.stringify(width) +  ', "enabled": ' + JSON.stringify(enabled) +  ', "backgroundColor": ' + JSON.stringify(backgroundColor) + ' },\n';
};
