...
Input DSL model: `/Users/wxy/model2blockly/examples/feature_pairs/04_constraint_subset/validatedApp.m2b`
...
2. Inspect `intermediate/ValidatedApp_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/ValidatedApp_standalone.html` in a browser to use the generated editor.
