// Block definitions for domain "ReferencesIntegrity".
...
window.BLOCKLY_BLOCKS = [
{
	...
	"message0": "Workflow",
					"args0": [],
	"message1": "Name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "Review workflow"}],
	"message2": "Elements %1",
						"args2": [{"type": "input_statement", "name": "elements", "check": "Element"}],
	"inputsInline": false,
	"colour": 260,
	"tooltip": "Workflow",
	"helpUrl": ""
},
{
	...
	"message0": "Card",
					"args0": [],
	"message1": "Card ID %1",
						"args1": [{"type": "field_input", "name": "cardId", "text": "card-1"}],
	"message2": "Title %1",
						"args2": [{"type": "field_input", "name": "title", "text": "Review"}],
	"message3": "Outgoing links %1",
						"args3": [{"type": "field_reference_multiselect", "name": "outgoing", "text": "", "targetType": "Link", "labelField": "linkId"}],
...
},
{
	...
	"message0": "Link",
					"args0": [],
	"message1": "Link ID %1",
						"args1": [{"type": "field_input", "name": "linkId", "text": "link-1"}],
	"message2": "Source card %1",
						"args2": [{"type": "field_dropdown", "name": "source", "options": [["(none)", ""]]}],
	"message3": "Description %1",
						"args3": [{"type": "field_input", "name": "description", "text": "Continue"}],
	"message4": "Target cards %1",
						"args4": [{"type": "field_reference_multiselect", "name": "target", "text": "", "targetType": "Card", "labelField": "title"}],
	"previousStatement": "Element", "nextStatement": "Element",
	"inputsInline": false,
	"colour": 120,
	"tooltip": "Link",
