// Code generators for domain "InteractiveApp".
...
javascript.javascriptGenerator.forBlock['Page'] = function(block) {
  ...
  return '{' +   '"_type": "Page", "_blockId": ' + JSON.stringify(block.id) +  ', "_modelId": ' + JSON.stringify(id || block.id) +  ', "id": ' + JSON.stringify(id) +  ', "title": ' + JSON.stringify(title) +  ', "description": ' + JSON.stringify(description) +  ', "backgroundColor": ' + JSON.stringify(backgroundColor) +  ', "scrollable": ' + JSON.stringify(scrollable) +  ', "alignment": ' + JSON.stringify(alignment) +   ', "components": ' + (components_stmt ? '[' + components_stmt + ']' : '[]') + ' },\n';
};
javascript.javascriptGenerator.forBlock['Container'] = function(block) {
  ...
  return '{' +   '"_type": "Container", "_blockId": ' + JSON.stringify(block.id) +  ', "layout": ' + JSON.stringify(layout) +   ', "children": ' + (children_stmt ? '[' + children_stmt + ']' : '[]') + ' },\n';
};
...
javascript.javascriptGenerator.forBlock['Button'] = function(block) {
  ...
  return '{' +   '"_type": "Button", "_blockId": ' + JSON.stringify(block.id) +  ', "text": ' + JSON.stringify(text) +  ', "width": ' + JSON.stringify(width) +  ', "enabled": ' + JSON.stringify(enabled) +  ', "backgroundColor": ' + JSON.stringify(backgroundColor) +   ', "onClick": ' + (onClick_stmt ? '[' + onClick_stmt + ']' : '[]') + ' },\n';
};
...
javascript.javascriptGenerator.forBlock['NavigateAction'] = function(block) {
  var target = block.getFieldValue('target');
  return '{' +   '"_type": "NavigateAction", "_blockId": ' + JSON.stringify(block.id) +  ', "target": ' + JSON.stringify(target) + ' },\n';
};
javascript.javascriptGenerator.forBlock['ShowMessageAction'] = function(block) {
  var message = block.getFieldValue('message');
  return '{' +   '"_type": "ShowMessageAction", "_blockId": ' + JSON.stringify(block.id) +  ', "message": ' + JSON.stringify(message) + ' },\n';
};
...
'Page': {
  label: 'Page',
  template: null,
  fields: ['id', 'title', 'description', 'backgroundColor', 'scrollable', 'alignment'],
  fieldTypes: {'id': 'TEXT', 'title': 'TEXT', 'description': 'TEXT', 'backgroundColor': 'COLOUR', 'scrollable': 'BOOLEAN', 'alignment': 'DROPDOWN'},
  references: [],
  values: [],
...
'Button': {
  label: 'Button',
  template: null,
  fields: ['text', 'width', 'enabled', 'backgroundColor'],
  fieldTypes: {'text': 'TEXT', 'width': 'INTEGER', 'enabled': 'BOOLEAN', 'backgroundColor': 'COLOUR'},
  references: [],
  values: [],
  statements: ['onClick']
},
