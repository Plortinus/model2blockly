// Block definitions for domain "InteractiveApp".
...
},
{
	...
	"message0": "Page",
					"args0": [],
	"message1": "id %1",
						"args1": [{"type": "field_input", "name": "id", "text": "home"}],
	"message2": "title %1",
						"args2": [{"type": "field_input", "name": "title", "text": "Home"}],
	"message3": "description %1",
						"args3": [{"type": "field_input", "name": "description", "text": "Main page"}],
	"message4": "backgroundColor %1",
						"args4": [{"type": "field_colour", "name": "backgroundColor", "colour": "#ffffff"}],
	"message5": "scrollable %1",
						"args5": [{"type": "field_checkbox", "name": "scrollable", "checked": true}],
	"message6": "alignment %1",
						"args6": [{"type": "field_dropdown", "name": "alignment", "options": [["left", "left"], ["center", "center"], ["right", "right"]]}],
	"message7": "components %1",
						"args7": [{"type": "input_statement", "name": "components", "check": "Component"}],
...
},
{
	...
	"message0": "Container",
					"args0": [],
	"message1": "layout %1",
						"args1": [{"type": "field_dropdown", "name": "layout", "options": [["column", "column"], ["row", "row"], ["grid", "grid"]]}],
	"message2": "children %1",
						"args2": [{"type": "input_statement", "name": "children", "check": "Component"}],
	"previousStatement": "Component", "nextStatement": "Component",
	"inputsInline": false,
	"colour": 290,
	"tooltip": "Group components in a nested layout.",
	"helpUrl": ""
},
{
	"type": "Label",
...
},
{
	...
	"message5": "onClick %1",
						"args5": [{"type": "input_statement", "name": "onClick", "check": "Action"}],
	"previousStatement": "Component", "nextStatement": "Component",
	"inputsInline": false,
	"colour": 20,
...
},
{
	...
	"message0": "Navigate",
					"args0": [],
	"message1": "target %1",
						"args1": [{"type": "field_dropdown", "name": "target", "options": [["(none)", ""]]}],
	"previousStatement": "Action", "nextStatement": "Action",
	"inputsInline": false,
	"colour": 20,
	"tooltip": "Open an existing page in the application.",
	"helpUrl": ""
},
{
	"type": "ShowMessageAction",
	"message0": "Show message",
					"args0": [],
	"message1": "message %1",
						"args1": [{"type": "field_input", "name": "message", "text": "Message"}],
	"previousStatement": "Action", "nextStatement": "Action",
	"inputsInline": false,
	"colour": 20,
	"tooltip": "Display text to the user.",
	"helpUrl": ""
}
];
