// Block definitions for domain "FieldsUi".
...
{
	"type": "ContentForm",
	"message0": "Content form",
					"args0": [],
	"message1": "Title %1",
						"args1": [{"type": "field_input", "name": "title", "text": "Welcome"}],
	"message2": "Description %1",
						"args2": [{"type": "field_input", "name": "description", "text": "Short description"}],
	"message3": "Quantity %1",
						"args3": [{"type": "field_number", "name": "quantity", "value": 3, "precision": 1, "min": 0, "max": 10}],
	"message4": "Opacity %1",
						"args4": [{"type": "field_number", "name": "opacity", "value": 0, "precision": 0.1, "min": 0, "max": 1}],
	"message5": "Enabled %1",
						"args5": [{"type": "field_checkbox", "name": "enabled", "checked": true}],
	"message6": "Confirmed %1",
						"args6": [{"type": "field_checkbox", "name": "confirmed", "checked": false}],
	"message7": "Mode %1",
						"args7": [{"type": "field_dropdown", "name": "mode", "options": [["simple", "simple"], ["advanced", "advanced"]]}],
	"message8": "Alignment %1",
						"args8": [{"type": "field_dropdown", "name": "alignment", "options": [["left", "left"], ["center", "center"], ["right", "right"]]}],
	"message9": "Tags %1",
						"args9": [{"type": "field_multivalue", "name": "tags", "label": "Tags", "text": "new,featured", "itemType": "TEXT", "options": [], "min": "", "max": "", "lowerBound": 1, "upperBound": 3, "unique": true, "ordered": true}],
	"message10": "Internal code %1",
						"args10": [{"type": "field_input", "name": "internalCode", "text": "FORM-01"}],
	"previousStatement": null, "nextStatement": null,
	"inputsInline": false,
	"colour": 180,
	"tooltip": "Content and control field examples.",
	"helpUrl": ""
},
{
	"type": "VisualFields",
	"message0": "visual fields colour %1 angle %2 image %3 label %4",
					"args0": [{"type": "field_colour", "name": "colourValue", "colour": "#1f6feb"}, {"type": "field_angle", "name": "angleValue", "angle": 45}, {"type": "field_image", "src": "https://developers.google.com/blockly/images/logos/logo_built_on.svg", "width": 32, "height": 32, "alt": "Blockly"}, {"type": "field_label", "name": "labelValue", "text": "Label"}],
	"previousStatement": null, "nextStatement": null,
	"inputsInline": false,
	"colour": 45,
	"tooltip": "Direct colour, angle, image, and label field mappings.",
