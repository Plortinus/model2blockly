...
window.BLOCKLY_BLOCKS = [
{
	...
	"message0": "Project",
					"args0": [],
	"message1": "name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "Website redesign"}],
	"message2": "workItems %1",
						"args2": [{"type": "input_statement", "name": "workItems", "check": "WorkItem"}],
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Project",
	"helpUrl": ""
},
{
	...
	"message0": "Task",
					"args0": [],
	"message1": "title %1",
						"args1": [{"type": "field_input", "name": "title", "text": "Design landing page"}],
...
},
{
	...
	"message0": "Milestone",
					"args0": [],
	"message1": "name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "First public release"}],
	"previousStatement": "WorkItem", "nextStatement": "WorkItem",
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Milestone",
...
},
{
	...
	"message0": "TeamMember",
					"args0": [],
	"message1": "name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "Alex"}],
