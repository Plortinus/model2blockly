...
2. Inspect `intermediate/SimpleApp_blocklyspec.xmi`, the generated EMF/XMI `EditorSpec` intermediate model.
3. Open `html/SimpleApp_standalone.html` in a browser to use the generated editor.
