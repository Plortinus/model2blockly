// Block definitions for domain "EcoreSpecific".
...
window.BLOCKLY_BLOCKS = [
{
	...
	"message0": "Catalog",
					"args0": [],
	"message1": "name %1",
						"args1": [{"type": "field_input", "name": "name", "text": "Technical catalog"}],
	"message2": "entries %1",
						"args2": [{"type": "input_statement", "name": "entries", "check": "NamedElement"}],
	"message3": "featured %1",
						"args3": [{"type": "field_dropdown", "name": "featured", "options": [["(none)", ""]]}],
	"inputsInline": false,
	"colour": 200,
	"tooltip": "Catalog",
	"helpUrl": ""
},
{
	...
	"message0": "Entry",
					"args0": [],
	"message1": "title %1",
						"args1": [{"type": "field_input", "name": "title", "text": "Named element"}],
	"message2": "entryId %1",
						"args2": [{"type": "field_input", "name": "entryId", "text": "entry-1"}],
	"message3": "longCount %1",
						"args3": [{"type": "field_number", "name": "longCount", "value": 1000, "precision": 1}],
	"message4": "shortCount %1",
						"args4": [{"type": "field_number", "name": "shortCount", "value": 12, "precision": 1}],
	"message5": "bigCount %1",
						"args5": [{"type": "field_number", "name": "bigCount", "value": 123456789, "precision": 1}],
	"message6": "doubleRatio %1",
						"args6": [{"type": "field_number", "name": "doubleRatio", "value": 0, "precision": 0.1}],
	"message7": "decimalRatio %1",
						"args7": [{"type": "field_number", "name": "decimalRatio", "value": 0, "precision": 0.1}],
	"previousStatement": "NamedElement", "nextStatement": "NamedElement",
	"inputsInline": false,
	"colour": 160,
	"tooltip": "Entry",
	"helpUrl": ""
